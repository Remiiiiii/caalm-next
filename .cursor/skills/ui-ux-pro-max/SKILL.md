...
name: ui-ux-pro-max
description: >-
  Searchable UI/UX design knowledge base with color palettes, typography, UX
  guidelines, and stack-specific rules. Use when designing, building, reviewing,
  or improving UI/UX for web or mobile apps.
---
