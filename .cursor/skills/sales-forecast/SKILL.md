...
name: sales-forecast
description: >-
  Cursor sales skill (Anthropic knowledge-work plugin). Generate a weighted sales forecast with best/likely/worst scenarios, commit vs. upside breakdown, and gap analysis. Use when preparing a quarterly forecast call, assessing gap-to-quota from a pipeline CSV, deciding which deals to commit vs. call upside, or checking pipeline coverage against your number.
...
Generate a forecast for the period the user named (or ask them for the period if missing).
