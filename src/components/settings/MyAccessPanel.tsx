						...
						<div className="flex min-w-0 flex-1 flex-wrap gap-3">
							{roles.length === 0 ? (
								...
								filteredRoles.map((role) => (
									<div
										key={role.roleId}
										className="flex items-center gap-2 rounded-lg border-2 border-slate-200 bg-linear-to-br from-blue-50 to-indigo-50 px-4 py-2 shadow-sm transition-all duration-200 hover:border-blue-300 hover:shadow-md"
									>
										<div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-linear-to-br from-blue-100 to-indigo-200">
