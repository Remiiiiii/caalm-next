...
export const ReportDocument: React.FC<ReportDocumentProps> = ({ data }) => {
	...
	const _formatAIContent = (content: string) => {
		...
		return sentences.map((sentence, index) => {
			...
			const isKeyPoint =
				/^(key|important|critical|significant|notable|finding|insight|recommendation)/i.test(
					trimmed,
				);
				...
				<View key={index} style={{ marginBottom: 8 }}>
					{isKeyPoint ? (
						<View style={{ flexDirection: "row", alignItems: "flex-start" }}>
							<Text
								style={[styles.aiText, { fontWeight: "bold", marginRight: 8 }]}
							>
								•
							</Text>
							<Text style={[styles.aiText, { fontWeight: "bold" }]}>
								{trimmed}
							</Text>
						</View>
					) : (
				...
				<View style={styles.section}>
					...
					<View style={styles.analysisBox}>
						<Text style={styles.analysisText}>
							...
							effective contract lifecycle management. The {metrics.users}{" "}
							active users suggest focused system utilization across
							departments, while {metrics.events} scheduled events demonstrate
							high engagement levels in audit and compliance activities. The{" "}
							{metrics.files} stored files indicate comprehensive document
							management practices for contracts, licenses, and audit records.
						</Text>
					</View>
				</View>
					...
					<View style={styles.riskList}>
						<View style={styles.riskItem}>
							...
							<Text style={styles.riskText}>
								Data Security: Ensure compliance with data protection
								regulations for all stored contracts and audit records,
						...
						<View style={styles.riskItem}>
							...
							<Text style={styles.riskText}>
								...
								compliance tracking systems for license and contract expiration
								dates
							</Text>
						</View>
						<View style={styles.riskItem}>
					...
					<View style={styles.recommendationsList}>
						<View style={styles.recItem}>
							...
							<Text style={styles.recText}>
								...
								procedures, and license tracking to increase system adoption and
