...
const COLORS = ['#0f5384', '#03AFBF', '#4CAF50', '#FF9800', '#9C27B0', '#F44336'];
...
export const MeetingLoadChart: React.FC<MeetingLoadChartProps> = ({ data }) => {
  ...
  const byDepartmentData = data.byDepartment.length > 0
    ...
    : [
        { name: 'All Departments', meetings: data.totalMeetings, hours: data.totalHours },
      ];
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-navy">{data.totalMeetings}</p>
              </div>
      ...
      <Card className="bg-white/30 backdrop-blur border border-white/40 shadow-lg">
        <CardHeader>
          <CardTitle className="h3 text-navy">Meeting Load by Day of Week</CardTitle>
          <CardDescription>
      ...
      {byTypeData.length > 0 && (
        <Card className="bg-white/30 backdrop-blur border border-white/40 shadow-lg">
          <CardHeader>
            <CardTitle className="h3 text-navy">Meeting Types Distribution</CardTitle>
      ...
      {byDepartmentData.length > 0 && (
        <Card className="bg-white/30 backdrop-blur border border-white/40 shadow-lg">
          <CardHeader>
            <CardTitle className="h3 text-navy">Meeting Load by Department</CardTitle>
            <CardDescription>
