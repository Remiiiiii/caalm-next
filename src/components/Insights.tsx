...
const Insights = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center py-14 sm:py-16 md:py-20 bg-gradient-to-b from-white to-blue-50 overflow-hidden">
      ...
      <div
        ref={paperRef}
        className="paper-3d relative z-10 w-full max-w-4xl mx-auto px-4 mt-8 rounded-2xl bg-white/60 backdrop-blur-md border border-white/40 shadow-sm p-4 sm:p-5"
      >
