...
const CSuitePage = () => {
	...
	} = useSWR("/api/analytics/calendar?days=90", fetcher, {
							...
							<>
								<div className="flex items-start space-x-3 p-4 bg-white/50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-slate-600">
											Meeting load has increased 15% this quarter. Average
											meeting duration is{" "}
											{calendarData.meetingLoad?.averageDuration?.toFixed(1) ||
												"0"}{" "}
											hours.
										</p>
									</div>
								...
								<div className="flex items-start space-x-3 p-4 bg-white/50 rounded-lg">
									...
									<div>
										...
										<p className="text-sm text-slate-600">
											Compliance deadline adherence improved 12% this month.
											Current rate:{" "}
											{calendarData.compliance?.complianceRate || 0}%.
										</p>
									</div>
								</div>

								{calendarData.resources &&
									calendarData.resources.utilizationRate < 85 && (
										<div className="flex items-start space-x-3 p-4 bg-amber-50 rounded-lg border border-amber-200">
											...
											<div>
												...
												<p className="text-sm text-amber-700">
													Resource booking efficiency at{" "}
													{calendarData.resources.utilizationRate}% (target:
													85%). Consider reviewing booking patterns and resource
													allocation.
												</p>
											</div>
										</div>
										...
										<div className="flex items-start space-x-3 p-4 bg-red-50 rounded-lg border border-red-200">
											...
											<div>
												...
												<p className="text-sm text-red-700">
													{calendarData.compliance.atRisk} compliance deadlines
													are at risk.
