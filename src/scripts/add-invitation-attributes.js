	...
	try {
		...
		for (const attr of attributes) {
			try {
				...
				if (attr.type === "string") {
					const _result = await databases.createStringAttribute(
						databaseId,
						collectionId,
						attr.key,
						attr.size,
					...
					const _result = await databases.createBooleanAttribute(
						databaseId,
						collectionId,
						attr.key,
						attr.required,
					...
					const _result = await databases.createDatetimeAttribute(
						databaseId,
						collectionId,
						attr.key,
						attr.required,
