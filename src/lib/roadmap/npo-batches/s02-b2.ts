...
export const NPO_BATCH_S02_B2 = {
	...
	tasks: [
		...
		{ taskCode: "2.8", title: "Pledge installments and due-date cron" },
		{ taskCode: "2.9", title: "Soft credits from household relationships" },
		{ taskCode: "2.10", title: "Link gifts to grant contracts" },
	],
} as const;
