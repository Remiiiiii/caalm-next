...
export async function updateNewsArticle(
  ...
  try {
    ...
    if (params.thumbnailPrompt !== undefined) updateData.thumbnailPrompt = params.thumbnailPrompt;
 ...
 */
export async function deleteNewsArticle(id: string, hardDelete: boolean = false): Promise<void> {
  try {
    const { tablesDB } = await createAdminClient();
