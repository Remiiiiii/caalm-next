    ...
    return (
      <div
        ...
        style={{
          ...
          height: size,
          borderRadius: "50%",
          backgroundColor: i % 2 === 0 ? "rgba(3,175,191,0.6)" : "rgba(255,255,255,0.8)",
          opacity,
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 24, zIndex: 1 }}>
        <Img src={staticFile("logo-brand.svg")} style={{ width: 80, height: 80 }} />
        <h1
          style={{
            fontSize: 110,
            fontWeight: 700,
    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow: "0 16px 40px 0 rgba(31,38,135,0.15), 0 0 0 1px #e2e8f0 inset",
          borderRadius: 12,
          overflow: "hidden",
          display: "flex",
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 20, zIndex: 1 }}>
        <Img src={staticFile("logo-brand.svg")} style={{ width: 70, height: 70 }} />
        <h1
          style={{
            fontSize: 90,
            fontWeight: 700,
...
export const CaalmDemoScene: React.FC = () => {
  return (
    ...
    >
      ...
      {/* 0:02 - 0:04+ */}
      <Sequence name="Beat 1 (Pending Approvals)" from={60} durationInFrames={72} layout="none">
        <ScreenshotFrame src="demo-01-pending-approvals.png" />
      </Sequence>

      {/* 0:04 - 0:06+ */}
      <Sequence name="Beat 2 (Contracts)" from={120} durationInFrames={72} layout="none">
        <ScreenshotFrame src="demo-07-contracts-full.png" />
      </Sequence>

      {/* 0:06 - 0:08+ */}
      <Sequence name="Beat 3 (Audit Charts)" from={180} durationInFrames={72} layout="none">
