...
Contract and license operations for multi-department teams — approvals, renewals, and compliance visibility.

Prices are **per workspace** (not per user). Yearly billing saves 20%.
...
- **Best for**: Small teams starting structured contract and license tracking.
- **Includes**:
  - Up to **3 departments**
...
### Add-ons (Starter & Growth)

- **Additional users**: $3 / user / month ($28.80 / year)
