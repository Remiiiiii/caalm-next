    ...
    for (const contract of contracts) {
      try {
        ...
        if (contract.selectedContractType) {
          console.log(`⏭️  Skipping contract ${contract.$id} - already has selectedContractType: ${contract.selectedContractType}`);
          skipped++;
          continue;
        }
...
export { migrateContracts, CONTRACT_TYPE_MAPPING };
